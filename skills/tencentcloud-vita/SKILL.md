...
description: >
  Skill for Tencent Cloud VITA image/video understanding. Analyzes images and videos using AI.
  Use when: understanding video content, analyzing images, generating descriptions, extracting
  highlights from sports events, analyzing surveillance footage, understanding live streams,
  summarizing news videos, analyzing product demo videos, or any visual media comprehension tasks.
  Supports single/multiple images and single video URL input with custom prompt instructions.
---
...
1. 登录腾讯云控制台：进入**图像分析与处理** --> **VITA 图像理解** --> **服务管理**
2. 首次使用需"确认开通服务"
